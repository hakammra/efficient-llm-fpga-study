# FPGA basics for the planned hardware study
...
**Simulation** executes the HDL model and checks functional outputs. **Synthesis** maps HDL to a logic representation and reports inferred resources. Physical FPGA implementation, timing, and power measurements would require a target board and appropriate tools. None is available for this study.
